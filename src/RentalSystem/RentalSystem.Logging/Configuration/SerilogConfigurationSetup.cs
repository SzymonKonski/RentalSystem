...
namespace RentalSystem.Logging.Configuration
{
    public static class SerilogConfigurationSetup
    {
        public static void WithCarsIslandConfiguration(this LoggerConfiguration loggerConfig, IConfiguration config)
        {
